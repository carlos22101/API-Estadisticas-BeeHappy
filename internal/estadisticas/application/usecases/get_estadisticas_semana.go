...
func (uc *GetEstadisticasSemanaUseCase) Execute(ctx context.Context, sensorID *int, macRaspberry *string) ([]domain.EstadisticasSemana, error) {
	return uc.repo.GetEstadisticasSemana(ctx, sensorID, macRaspberry)
}